...
Base.exports.PaperScript = function() {
	...
	if (!acorn && "function" !== 'undefined') {
		try { acorn = __webpack_require__(2); } catch(e) {}
	}
	if (!acorn) {
		var exports, module;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(paper) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var Charterial = (function () {
    function Charterial(options) {
        ...
        this.createCanvases = function () {
            ...
            ['graphs', 'markings', 'overlay'].forEach(function (name) {
                var canvas = document.createElement("canvas");
                canvas.id = name + 'Canvas';
                canvas.className = name + '-canvas';
                canvas.dataset.paperResize = 'true';
                _this.canvasElements[name] = canvas;
                _this.wrapperDiv.appendChild(canvas);
            });
        };
        /**
         * Creates the PaperJS objects and the layers and interaction event handlers we need.
         */
        this.setupPaper = function () {
            // setup the main paperjs scope
            _this.graphsPaper = new paper.PaperScope();
            _this.graphsPaper.setup(_this.canvasElements['graphs']);
            // setup the markings paperjs scope
            _this.markingsPaper = new paper.PaperScope();
            _this.markingsPaper.setup(_this.canvasElements['markings']);
            // setup the overlay paperjs scope
            _this.overlayPaper = new paper.PaperScope();
            _this.overlayPaper.setup(_this.canvasElements['overlay']);
            _this.interactionTool = new paper.Tool();
            _this.interactionTool.minDistance = 0;
            _this.interactionTool.onMouseMove = _this.mouseMove;
            _this.interactionTool.onMouseUp = _this.mouseUp;
            _this.interactionTool.onMouseDrag = _this.mouseDrag;
            ...
            _this.graphsPaper.activate();
            var layer = new _this.graphsPaper.Layer();
            layer.setName('axis');
            layer = new _this.graphsPaper.Layer();
            ...
            _this.markingsPaper.activate();
            layer = new _this.markingsPaper.Layer();
            layer.setName('globalTimemarker');
            layer = new _this.markingsPaper.Layer();
            layer.setName('timemarker');
            // add the messages layer
            _this.overlayPaper.activate();
            layer = new _this.overlayPaper.Layer();
